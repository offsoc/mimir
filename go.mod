...
require (
	...
	github.com/grafana/alerting v0.0.0-20240906191856-cdc634f213ea
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v0.0.0-20240917104844-e4312d119ad6
